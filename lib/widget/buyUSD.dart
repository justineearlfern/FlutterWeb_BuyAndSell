...
class BuyUSD extends StatefulWidget {
  const BuyUSD({Key key}) : super(key: key);

  @override
  BuyUSDState createState() => new BuyUSDState();
}

class BuyUSDState extends State<BuyUSD> {
                                ...
                                child: FutureBuilder<USDBNS>(
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.hasData) {
                                      ...
                                      quotedPrice = double.parse(_sellPrice());
                                      return Text("${_sellPrice()}");
                  ...
                  onPressed: () {
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Text('You have successfully bought USD'),
